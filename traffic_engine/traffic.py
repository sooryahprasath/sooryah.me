...
from flask_cors import CORS  # REQUIRED
from ultralytics import YOLO

app = Flask(__name__)
CORS(app) # Allow the website on 8090 to talk to this API
        ...
        if os.path.exists(self.file):
            try:
                with open(self.file, 'r') as f:
                    self.total_count = json.load(f).get("total", 0)
